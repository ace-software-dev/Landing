                        ...
                        <form className="w-full md:w-3/4">
                            <div className="flex-col justify-start items-center gap-8 flex">
                                ...
                                <div className="self-stretch flex-col justify-start items-start gap-2 flex">
                                    ...
                                    <textarea id="numero" name="numero" placeholder="Escribe aquí..." required className="self-stretch h-40 px-4 py-[18px] bg-slate-700 rounded-xl justify-top items-start gap-2.5 inline-flex text-slate-50 text-xl focus:ring-2 focus:ring-inset focus:ring-indigo-600" />
                                </div>
                            </div>
                        </form>
                    </div>
